...
| 04 | `Ryokan Night (温泉旅館の夜)` | 約61分 | 確認済み | **3000×3000済み**（2026-09-08、右側コラージュを正方形切り出し） | 未入稿 |
| 05 | `Bamboo Forest (竹林の朝)` | 約68分 | 確認済み | **3000×3000済み**（同上） | 未入稿。タイトル表記は未確定（changelog参照） |
| 06 | `Cherry Blossom Kyoto (桜舞う京都)` | 約64分 | 確認済み | **3000×3000済み**（同上） | 未入稿 |
...
1. **ジャケット画像の3000×3000リサイズ**（04・05・06は完了。07〜10の4枚が残り）
...
└── Ongaku Toshokan/           ← .gitignore対象
    └── Madobe no shiki/
        ...
        └── ...（03〜10も同様の構成。04・05・06のジャケットは3000×3000済み）
```
