...
## リリース頻度・入稿カレンダーの検討経緯
Level Trimと合わせて**週2〜3件を、週末にまとめて予約投稿**したいという希望を確認。27〜29営業日の審査期間を踏まえ、7週間の安全マージンで逆算した入稿カレンダーを検討。最新の確定版は [master20260824.md](./master20260824.md) を参照（本書には経緯のみ記載、日付は更新のたび古くなるため転記しない）。
