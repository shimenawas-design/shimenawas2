...
| 3〜6 | 未定 | 140/155/145/158 | — | — | 企画のみ（4.1節のラダー案参照） |
...
| 3 | 未定 | 140 | ③808を重く獰猛に | 高重量セット |
| 4 | 未定 | 155 | ②カウベルを密に | HIIT・インターバル |
| 5 | 未定 | 145 | ⑤ドライで没入的に | 集中したい単独セット |
| 6 | 未定 | 158 | ④ローファイ質感を強めに | ウォームアップ・雰囲気重視 |

6曲揃った時点で「同一ジャンルで3〜5リリース」というSpotifyの安定分類条件を満たす想定。
...
4. Track #3〜6の設計（4.1節のラダー案に沿って副変数を1つずつ割り当てる）
