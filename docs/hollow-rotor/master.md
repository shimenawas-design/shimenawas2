...
| 2 | Rev Limiter | 160 | 未生成 | 未生成 | **確定（2026-09-08）**。プロンプトは[prompts.md](./prompts.md)参照 |
...
3. Track #2「Rev Limiter」のSuno生成・ジャケット生成（プロンプト確定済み、[prompts.md](./prompts.md)参照）
